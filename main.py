...
class MainWidget(RelativeLayout):
    ...
    menu_title = StringProperty("E  S  C  A  P  E")
    ...
    def reset_game(self):
        ...
        self.score_txt = "SCORE: " + str(self.current_y_loop) + "     " + \
            "HIGH SCORE: " + str(max(self.current_y_loop, self.high_score))
    ...
    def update(self, dt):
        ...
        if not self.state_game_over and self.state_game_has_started:
            ...
            while self.current_offset_y >= spacing_y:
                ...
                self.score_txt = "SCORE: " + \
                    str(self.current_y_loop) + "     " + "HIGH SCORE: " + \
                    str(max(self.current_y_loop, self.high_score))
                self.high_score = max(self.current_y_loop, self.high_score)
                self.generate_tiles_coordinates()
